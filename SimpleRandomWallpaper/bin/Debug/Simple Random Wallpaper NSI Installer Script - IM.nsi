...
;copy translations end
  ...
  !define MUI_FILE "SimpleRandomWallpaper"
  !define MUI_VERSION ""
...
;create start-menu items
  ...
  CreateShortCut "$SMPROGRAMS\${PRODUCT_SHORTCUT}\Simple Random Wallpaper - User's Manual.url.lnk" "$INSTDIR\Simple Random Wallpaper - User's Manual.url" "" "$INSTDIR\Simple Random Wallpaper - User's Manual.url" 0
...
;Add files
 ...
 ;Call IsDotNetInstalledAdv
  ...
  File "Simple Random Wallpaper - User's Manual.url"

  nsExec::Exec '"$INSTDIR\SimpleRandomWallpaper.exe" -setpermissions';
