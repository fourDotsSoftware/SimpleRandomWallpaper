...
namespace SimpleRandomWallpaper
{
    class Module
    {
        ...
        public static string AcceptableMediaInputPattern = "*.png;*.jpg;*.jpeg;*.gif;*.bmp;";        
        ...
        public static string TempFolder
        {
            get
            {
                string path = System.IO.Path.Combine(System.IO.Path.GetTempPath(), "SimpleRandomWallpaper");
